...
class ContextBuilder:
    ...
    def update_system_and_user_context(self) -> None:
        sys_txt = self._read_folder(self.paths.system_dir)
        ctx_txt = self._read_folder(self.paths.user_context_dir)
        self.cache.set_section("system", "SYSTEM PROMPT", sys_txt)
